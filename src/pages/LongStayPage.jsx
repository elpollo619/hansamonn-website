...
const longStayItems = [
  {
    ...
    description:
      "Praktische Long-Stay-Lösung für längere Aufenthalte mit funktionalen und komfortablen Wohnmöglichkeiten.",
  ...
  },
  {
    ...
    description:
      "Long-Stay-Angebot mit Zimmern und Gemeinschaftsbereichen für temporäres Wohnen und längere Aufenthalte.",
  ...
  },
  {
    ...
    description:
      "Wohnlösung in guter Lage für Long-Stay-Gäste, Mitarbeitende und befristete Aufenthalte in der Region Bern.",
    link: "/long-stay/muri",
  },
];
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-slate-600 max-w-3xl leading-8">
              Unsere Long-Stay-Angebote eignen sich ideal für längere Aufenthalte,
              temporäres Wohnen, Mitarbeitende und flexible Wohnlösungen in der
              Region.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 py-16">
          <div className="max-w-4xl rounded-3xl border border-slate-200 bg-white p-8 md:p-10 shadow-sm">
            <h2 className="text-3xl font-bold mb-4">
              Allgemeine Mietanfrage für Long Stay
            </h2>

            <p className="text-slate-600 leading-8 mb-8">
              Sie können uns auch direkt eine allgemeine Anfrage senden. Im
              Formular können Sie das gewünschte Long-Stay-Objekt auswählen.
            </p>

            <Link
              to="/vermieten?anfrageart=Long%20Stay"
