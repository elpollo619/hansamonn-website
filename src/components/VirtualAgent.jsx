...
const KB = {
  de: {
    ...
    fallback: 'Zu dieser Frage kann ich Ihnen am besten direkt weiterhelfen. Schreiben Sie uns: office@reto-amonn.ch oder rufen Sie uns an: +41 (0)31 951 85 54.',
    fallbackLink: '/kontakt',
    suggestions: [
      { label: 'Long Stay entdecken', q: 'Was ist Long Stay?' },
      { label: "N's Hotel ansehen", q: "Wie buche ich N's Hotel?" },
      { label: 'Casa Reto entdecken', q: 'Was ist Casa Reto?' },
      { label: 'Architektur Leistungen', q: 'Welche Architekturleistungen bieten Sie an?' },
      { label: 'Neubau anfragen', q: 'Ich möchte ein Haus bauen lassen.' },
      { label: 'Kontakt aufnehmen', q: 'Wie erreiche ich Sie?' },
    ],
    intents: [
      {
      ...
      {
        id: 'anfrage-form',
        triggers: ['anfrage', 'formular', 'mietanfrage', 'anfragen', 'kontaktformular', 'wie bewerbe', 'bewerben'],
        answer: 'Nutzen Sie unser Anfrageformular: Persönliche Daten → Gewünschtes Objekt → Datum & Dauer → Nachricht → Bestätigung. Wir antworten innerhalb von 24 Stunden.',
        link: '/vermieten',
        linkLabel: 'Zur Mietanfrage',
      },
      {
        id: 'contact',
        triggers: ['kontakt', 'erreich', 'telefon', 'email', 'e-mail', 'büro', 'office', 'öffnungszeiten', 'anrufen', 'schreiben'],
        answer: 'Telefon: +41 (0)31 951 85 54 | E-Mail: office@reto-amonn.ch | Adresse: Blümlisalpstrasse 4, 3074 Muri bei Bern.',
        link: '/kontakt',
        linkLabel: 'Kontaktseite',
      },
      {
        id: 'diff-long-short',
        triggers: ['unterschied', 'vergleich', 'besser', 'welche option', 'was passt', 'long oder short', 'was empfehlen'],
        answer: 'Long Stay: ab 1 Monat, möblierte Zimmer, inkl. Nebenkosten, für Mitarbeitende & Firmenkunden. Short Stay: hotel- oder ferienhausartige Unterkünfte für Nächte oder Wochen.',
        link: '/immobilien',
      ...
      {
        id: 'availability',
        triggers: ['wann', 'ab wann', 'verfügbarkeit', 'frei ab', 'sofort', 'kurzfristig'],
        answer: 'Long Stay Zimmer sind teilweise kurzfristig verfügbar. Für aktuelle Verfügbarkeit kontaktieren Sie uns direkt oder stellen Sie eine Anfrage über das Formular.',
        link: '/vermieten',
