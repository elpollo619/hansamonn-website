    ...
    <div className="bg-white border border-gray-100 overflow-hidden">
      ...
      <div className="p-6 md:p-8 grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="flex justify-between items-baseline mb-2">
              <label className="text-xs font-semibold uppercase tracking-wider text-gray-500">Eigenkapital</label>
          ...
          {/* Laufzeit */}
          <div>
            <label className="text-xs font-semibold uppercase tracking-wider text-gray-500 block mb-2">Laufzeit</label>
        ...
        <div className="space-y-4">
          <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Ergebnis</h3>
          ...
          <div className={`p-4 ${
            tragbarkeitOk === null
              ? 'surface-warm'
              : tragbarkeitOk
              ? 'surface-warm border border-gray-200'
            ...
            <div className="flex items-start justify-between gap-2">
              ...
              {tragbarkeitOk !== null && (
                <span className={`text-xs font-semibold px-2.5 py-1 mt-1 ${
          ...
          <div className={`flex items-center gap-3 px-4 py-3 text-sm ${
            ltvOk ? 'surface-warm text-gray-700' : 'bg-red-50 text-red-700'
          }`}>
      ...
      {/* Disclaimer + CTA */}
      <div className="border-t border-gray-100 px-6 md:px-8 py-5 surface-warm flex flex-col sm:flex-row sm:items-center gap-4">
