...
export const projectsData = [
  ...
  },
  {
    ...
    gallery: [
      ...
      { type: 'compare', before: '/images/projekte/hoeheweg/bestand-2000-so.jpg', after: '/images/projekte/hoeheweg/umbau-3d-so.jpg',
        beforeLabel: 'Bestand 2000', afterLabel: 'Umbauprojekt 3D', beforeAlt: 'Wohnteil mit Fachwerkgiebel und Laube (2000)', afterAlt: '3D-Modell des Umbauprojekts aus demselben Blickwinkel',
        caption: 'Wohnteil mit Fachwerkgiebel und Laube – Foto von 2000 und das 3D-Modell aus den Fassadenplänen.' },
      { type: 'header', title: 'Geschichte' },
      { type: 'image', url: '/images/projekte/hoeheweg/kraeyigen-historisch.jpg', alt: 'Historische Postkarte «Kräyigen bei Muri»' },
      { type: 'image', url: '/images/projekte/hoeheweg/bestand-1999-sued.jpg', alt: 'Südfassade mit Garten (1999)' },
    ],
  ...
  },
  {
    ...
    gallery: [
      { type: 'image', url: '/images/projekte/bremgarten-3d.jpg', alt: '3D-Modell aus den Ausführungsplänen, mit Umgebung (Aare, Gelände swissALTI3D)' },
      { type: 'image', url: '/images/projekte/bremgarten/baugrube-aare.jpg', alt: 'Baugrube am Hang über der Aare (September 2026)' },
      { type: 'image', url: '/images/projekte/bremgarten/baugrube-nagelwand.jpg', alt: 'Hangsicherung mit Nagelwand' },
      { type: 'header', title: 'Baufortschritt' },
      { type: 'image', url: '/images/projekte/bremgarten/absteckung.jpg', alt: 'Absteckung mit GNSS direkt aus den Plänen' },
      { type: 'image', url: '/images/projekte/bremgarten/aushub.jpg', alt: 'Aushub entlang der Stützmauer' },
      { type: 'image', url: '/images/projekte/bremgarten/kran.jpg', alt: 'Der Bagger wird per Kran in die Baugrube gehoben' },
      { type: 'image', url: '/images/projekte/bremgarten/gnss-rover.jpg', alt: 'GNSS-Rover über dem Messpunkt' },
    ],
