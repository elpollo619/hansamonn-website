// Project updates shown on /neuigkeiten while no blog posts are published (or the blog can't be reached).
// Each card links to the project page instead of a blog article.
export const PROJECT_NEWS = [
  {
    id: 'bremgarten-baustart',
    href: '/projekte/5',
  ...
  },
  {
    ...
    title: 'Unsere Projekte in 3D',
    excerpt: 'Direkt aus den Ausführungsplänen: Gebäude drehen, Geschosse einblenden und in die Explosionsansicht wechseln.',
    cover_image: '/images/projekte/hoeheweg-3d.jpg',
  },
  {
    id: 'baeren-kerzers',
    href: '/projekte/4',
