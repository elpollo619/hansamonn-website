...
const DEFAULT_PROPERTIES = [
  ...
  },
  {
    ...
    images: [
      ...
      '/images/ns-hotel/lounge.jpg',
      '/images/ns-hotel/doppelzimmer.jpg',
      '/images/ns-hotel/familienzimmer.jpg',
      '/images/ns-hotel/zimmer-barrierefrei.jpg',
      '/images/ns-hotel/kueche.jpg',
      '/images/ns-hotel/lounge-kueche.jpg',
      '/images/ns-hotel/bad.jpg',
      '/images/ns-hotel/kochnische.jpg',
      '/images/ns-hotel/06.jpg',
      '/images/ns-hotel/08.jpg',
      '/images/ns-hotel/schliessfaecher.jpg',
    ],
    link: '/ns-hotel',
...
function migrate(props) {
  return props.map((p, index) => {
    ...
    return {
      ...
      seasons: p.seasons || def?.seasons || [],
      priceClean: p.priceClean ?? def?.priceClean ?? null,
