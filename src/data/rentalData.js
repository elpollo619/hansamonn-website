...
export const rentalData = [
...

  {
    ...
    lat: 46.18,
    lng: 8.86,
    subtitle: 'Ferienhaus im Tessin mit Garten, Pergola und Blick auf den Lago Maggiore',
    ...
    availableFrom: null,
    furnished: true,
    minimumStay: 'Bevorzugt wochenweise',
    directBookingUrl: null,
    bookingUrls: {
      booking: 'https://www.booking.com/hotel/ch/casa-reto-das-ferienhaus-im-tessin.de.html',
      airbnb:  'https://www.airbnb.ch/rooms/625660996936132774',
    },
    icalUrl: 'https://www.airbnb.ch/calendar/ical/625660996936132774.ics?t=82a02050ce864c73b599648976548358',
    description:
      'Ferienhaus im Dorfkern von Gordemo, oberhalb von Tenero am Eingang zum Verzascatal. Casa Reto bietet vier Schlafzimmer für bis zu acht Gäste (drei Doppelbetten, zwei Einzelbetten), zwei Duschbäder, Wohnzimmer mit Holzofen und eine Küche mit Essplatz für acht. Dazu ein eigener Garten mit Pergola, Granittisch, Grill und weitem Blick über den Lago Maggiore, zwei Parkplätze und eine Ladestation für Elektroautos.',
    images: [
      { url: '/images/casa-reto/titel.jpg',               alt: 'Blick von der Casa Reto über den Lago Maggiore' },
      { url: '/images/casa-reto/garten-pergola.jpg',      alt: 'Granittisch unter der Pergola mit Seeblick' },
      { url: '/images/casa-reto/wohnzimmer-1.jpg',        alt: 'Wohnzimmer mit Holzofen' },
      { url: '/images/casa-reto/essen-1.jpg',             alt: 'Essplatz für acht Personen mit Küche' },
      { url: '/images/casa-reto/zimmer2-1.jpg',           alt: 'Schlafzimmer mit Doppelbett und Balkon' },
      { url: '/images/casa-reto/aussicht-nacht.jpg',      alt: 'Lichter am Lago Maggiore am Abend' },
    ],
    features: [
      'Blick auf den Lago Maggiore', '4 Schlafzimmer, 5 Betten', 'Bis 8 Gäste',
      'Holzofen im Wohnzimmer', 'Garten mit Pergola und Grill', 'Balkon im Obergeschoss',
      '2 Parkplätze und E-Ladestation', 'WLAN und Arbeitsplatz', 'Haustiere willkommen',
    ],
    details: { parking: '2 Parkplätze, E-Ladestation', pets: 'Willkommen', bedrooms: 4, bathrooms: 2, maxGuests: 8 },
    contact: { phone: '+41 (0)31 951 85 54', email: 'office@reto-amonn.ch' },
  },
