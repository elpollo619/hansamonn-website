...
export const rentalData = [
...

  {
    ...
    description:
      'Traumhaftes Ferienhaus in Gordemo am Lago Maggiore im Tessin. Casa Reto verbindet tessiner Architektur mit modernem Komfort: vier Schlafzimmer für bis zu acht Gäste, offener Wohn- und Küchenbereich mit Cheminée sowie ein grosser Garten mit Pergola, Granittisch und unverbautem Blick auf den Lago Maggiore. Ruhige Lage am Eingang zum Verzascatal, nur 10 Autominuten von Ascona und Locarno.',
    images: [
      { url: '/images/casa-reto/titel.jpg', alt: 'Casa Reto – Ferienhaus im Tessin mit Blick auf den Lago Maggiore' },
      { url: '/images/casa-reto/01.jpg',    alt: 'Casa Reto – Aussenansicht des Ferienhauses' },
      { url: '/images/casa-reto/02.jpg',    alt: 'Garten mit Pergola und Seeblick' },
      { url: '/images/casa-reto/03.jpg',    alt: 'Offener Wohn- und Küchenbereich mit Cheminée' },
      { url: '/images/casa-reto/04.jpg',    alt: 'Schlafzimmer im Obergeschoss' },
    ],
    features: [
      'Garten mit Seeblick', '4 Schlafzimmer', 'Bis 8 Gäste',
      'Offene Küche mit Cheminée', 'Pergola & Granittisch', 'Familienfreundlich',
      'Vollmöbliert', 'Parkplatz', 'Ruhige Lage am Verzascatal',
    ],
    details: { parking: 'Vorhanden', pets: 'Nach Absprache', bedrooms: 4, bathrooms: 2, maxGuests: 8 },
    contact: { phone: '+41 (0)31 951 85 54', email: 'office@reto-amonn.ch' },
  },
